...
complete -c tre -s c -l color -d 'When to color the output. `automatic` means when printing to a terminal, tre will include colors; otherwise it will disable colors' -r -f -a "automatic\t''
always\t''
never\t''"
...
complete -c tre -s h -l help -d 'Print help'
